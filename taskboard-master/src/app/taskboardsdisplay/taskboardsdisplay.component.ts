...
export class TaskboardsdisplayComponent implements OnInit {
  ...
  chst;
  arr: Taskboards[] = [
    new Taskboards(1, 'create website', '14/08/2019', 'Online room booking', 'High', 'shan', '13/08/2019', 'good design', ''),
    ...
    new Taskboards(4, 'create website', '17/08/2019', 'Online room booking', 'High', 'John', '13/08/2019', 'good design', ''),
    new Taskboards(5, 'create website', '18/08/2019', 'Online room booking', 'High', 'Sharma', '13/08/2019', 'good design', ''),
    new Taskboards(6, 'create website', '19/08/2019', 'Online room booking', 'High', 'keerti', '13/08/2019', 'good design', ''),
    new Taskboards(7, 'create website', '16/08/2019', 'Online room booking', 'High', 'Rama', '13/08/2019', 'good design', ''),
